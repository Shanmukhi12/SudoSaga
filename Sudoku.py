...
def generate_random_board():
    ...
    for _ in range(random.randint(12, 24)):  # Randomly fill cells
        row, col, num = random.randint(0, 8), random.randint(0, 8), random.randint(1, 9)
        while not valid(base, num, (row, col)):
            row, col, num = random.randint(0, 8), random.randint(0, 8), random.randint(1, 9)
        base[row][col] = num
    return base
...
def redraw_window(win, board, time, strikes, display_win):
    ...
    if display_win:
        # text = fnt.render("Game Over, You Won!!", 1, (0, 255, 0)) 
        # win.blit(text, (50, 640))
        text = 'You Won!'
        text_surface = fnt.render(text, True, (255, 0, 0))
        text_rect = text_surface.get_rect(center=(70, 250))
...
def main():
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.type == pygame.VIDEORESIZE:
                    ...
                    board = Grid(9, 9, event.w, event.h, win)
        ...
        redraw_window(win, board, play_time, strikes, display_win)
        pygame.display.update()
